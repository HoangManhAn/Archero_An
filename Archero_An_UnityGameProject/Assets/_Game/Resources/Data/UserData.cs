...
public class UserData : ScriptableObject
{
    ...
    public void OnInitData()
    {
        ...
        playerWeapon = GetEnumData(Key_Player_Weapon, WeaponType.W_Knife_1);
        playerHat = GetEnumData(Key_Player_Hat, HatType.Cowboy_1);
        playerPant = GetEnumData(Key_Player_Pant, PantType.Pant_White);
        //playerAccessory = GetEnumData(Key_Player_Accessory, AccessoryType.ACC_None);
        playerSkin = GetEnumData(Key_Player_Skin, SkinType.Red);
    }
