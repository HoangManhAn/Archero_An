...
public class Tank : Minion
{
    ...
    public List<Transform> tankMinionSpawnPoint = new List<Transform>();

    public Normal tankMinion;
    ...
    public override void OnDespawn()
    {
        ...
        for (int i = 0; i < tankMinionSpawnPoint.Count; i++)
        {
            Normal minion = Instantiate(tankMinion, tankMinionSpawnPoint[i].position, tankMinionSpawnPoint[i].rotation );
            minion.OnInit();
            LevelManager.Ins.currentLevel.enemies.Add(minion);
        }
