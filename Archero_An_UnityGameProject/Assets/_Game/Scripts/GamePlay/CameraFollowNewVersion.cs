...
public class CameraFollowNewVersion : Singleton<CameraFollowNewVersion>
{
    ...
    [Header("Rotation")]
    [SerializeField] Vector3 heroRotate;
    [SerializeField] Vector3 gamePlayRotate;

    [Header("Offset")]
    [SerializeField] Vector3 heroOffset;
    ...
    public void ChangeState(State state)
    {
        ...
        //{
        //    case State.MainMenu:
        //        targetOffset = heroOffset;
        //        targetRotate = Quaternion.Euler(heroRotate);
        //        break;
