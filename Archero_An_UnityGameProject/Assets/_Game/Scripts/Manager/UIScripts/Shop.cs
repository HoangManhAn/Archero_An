...
{
    public enum ShopType { Hat, Pant, Skin, Weapon }
    ...
    public override void Open()
    {
        ...
        CameraFollowNewVersion.Ins.ChangeState(CameraFollowNewVersion.State.Shop);
    ...
    internal void SelectBar(ShopBar shopBar)
    {
        ...
        switch (currentBar.Type)
        {
            case ShopType.Weapon:
                InitShopItems(data.weapons.Ts, ref itemEquiped);
                break;
            case ShopType.Hat:
    ...
    public List<ShopItemData<T>> GetListItems<T>(ShopType shopType) where T : Enum
    {
        switch (shopType)
        {
            ...
            case ShopType.Weapon: return data.weapons.Ts as List<ShopItemData<T>>;
    ...
    public void EquipButton()
    {
        if (currentItem != null)
        {
            ...
            switch (shopType)
            {
                ...
                case ShopType.Weapon:
                    UserData.Ins.SetEnumData(UserData.Ins.playerPant.ToString(), ShopItem.State.Bought);
                    UserData.Ins.SetEnumData(UserData.Key_Player_Weapon, ref UserData.Ins.playerWeapon, (WeaponType)currentItem.Type);
                    break;
                default:
                    break;
            }
